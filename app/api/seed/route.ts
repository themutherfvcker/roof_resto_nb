  ...
  const rows = [
    {
      ...
      content_html: '<p>We restore, repair and paint roofs in Dee Why. Licensed & insured. <strong>Get a free quote today.</strong></p>',
      faqs_json: [
    ...
    },
    {
      ...
      content_html: '<p>We restore, repair and paint roofs in Mona Vale. Licensed & insured. <strong>Get a free quote today.</strong></p>',
      faqs_json: [
        { q: 'Do you repair leaks?', a: 'Yes, leak repairs, repointing, resealing and painting.' }
      ],
      status: 'published'
    }
  ]
